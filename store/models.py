...
class ProductType(models.Model):
    """
    ProductType Table will provide a list iof the different types
...
class ProductSpecification(models.Model):
    """
    The Product specification Table contains products
...
class Product(models.Model):
    """
    The product tabke containing all the product items.
    """
...
class ProductSpecificationValue(models.Model):
    """
    The Product Specification Value holds each of the products individual specification
    or bespoke features.
    """
